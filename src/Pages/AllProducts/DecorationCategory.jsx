      ...
      <div className="d-flex container pb-3">
        <div className="w-75 mt-5 pe-5 pb-5">
          <div className="d-flex">
            ...
            <div className="fw-semibold fs-5"> Decoration </div>
          </div>
          <h1 className="mt-3">Decoration</h1>
          <div className="d-flex justify-content-end">
            <form className="woocommerce-ordering" method="get">
              <select
                onChange={(value) => onChangeSortDeco(value)}
                name="orderby"
          ...
          <div>
            <div className="row">
              {/* Display Items in Decoration Category */}
              {displayPageDeco.map((product) => (
